-- 035: Repair the double-encoded Hebrew that landed in profession_types
-- after migration 034 ran through a non-utf8mb4 mysql client. The
-- source SQL of 034 has the right bytes (0xD7 0xA8 = ר, etc.), but
-- some earlier client connection re-encoded them on the way in,
