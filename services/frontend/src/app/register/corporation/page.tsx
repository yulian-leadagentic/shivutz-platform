...
const TC_VERSION = '2026-08-13.v3';
const TC_TEXT = `
...
2. תשלום ומינוי
השימוש בפלטפורמה נגבה במודל מנוי חודשי/שנתי לפי המסלול שהתאגיד בחר. המנוי מקנה מכסת פרסום מודעות (עובדים/דיור) וחשיפת פרטי קשר בהתאם למסלול. פרטי מסלולים, מחירים, חיוב, ותנאי ביטול — במסך "חשבון ומנוי" בתוך הפורטל.
