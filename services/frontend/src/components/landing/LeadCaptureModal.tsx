        ...
        <div className="px-7 py-6">
          {submitted ? (
            <div className="flex flex-col items-center gap-4 py-6 text-center">
              ...
              <Button onClick={handleClose} className="mt-2 w-full bg-brand-600 hover:bg-brand-800 text-slate-900">
                סגור
              </Button>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button
                type="submit"
                disabled={submitting}
                className="w-full h-11 bg-brand-600 hover:bg-brand-800 text-slate-900 font-semibold shadow-lg shadow-brand-600/20"
              >
                {submitting ? (
