...
const STEPS = [
  {
    ...
    description:
      'קבלן או תאגיד — מלא פרטים, העלה מסמכים נדרשים (רישיון, תעודת רישום). הצוות שלנו מאמת ומאשר בתוך 48 שעות.',
  ...
  },
  {
    ...
    description:
      'קבלן מגדיר דרישות (מקצוע, ניסיון, שפות, אזור). מנוע ההתאמה מוצא את חבילות העובדים המתאימות בתוך שניות.',
