        ...
        {sent ? (
          <div className="text-center py-6 space-y-3">
            ...
            <button
              type="button"
              onClick={close}
              className="mt-2 bg-brand-800 hover:bg-brand-900 text-white text-sm font-semibold px-5 py-2 rounded-lg"
            >
              סגור
            </button>
          </div>
          ...
          <>
            ...
            <form onSubmit={submit} className="space-y-3">
              ...
              <button
                type="submit"
                disabled={busy}
                className="w-full bg-brand-800 hover:bg-brand-900 text-white font-semibold py-2.5 rounded-lg disabled:bg-slate-300 inline-flex items-center justify-center gap-2"
              >
