        ...
        <div className="space-y-2">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="bg-brand-600 hover:bg-brand-800 text-slate-900 text-xs font-semibold px-3 py-2 rounded-lg disabled:bg-slate-300 inline-flex items-center gap-1"
            >
