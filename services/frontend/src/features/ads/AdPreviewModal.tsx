      ...
      <div ref={dialogRef}
        ...
        <div className="flex gap-2 pt-2">
          ...
          <button
            ...
            onClick={confirm}
            disabled={busy}
            className="flex-[2] bg-brand-600 hover:bg-brand-800 text-slate-900 font-semibold py-2.5 rounded-lg disabled:bg-slate-300 inline-flex items-center justify-center gap-2"
          >
