...
const services = {
  ...
  // proxy mapping here — every /api/legal/* call fell through to the
  // default 404 handler. Surfaced by S1 smoke test §2.2 B2.
  '/api/legal':         process.env.USER_ORG_SERVICE_URL      || 'http://user-org:3002',
